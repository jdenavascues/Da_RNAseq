...
ggplot(NES.df, aes(x=ID, y=condition)) +
  ...
  geom_point(data=padj.df,
             ...
             size=5, shape=4, stroke=3, alpha=1) +
  ...
  scale_x_discrete(position = "top", expand = expansion(mult = 0, add = 0)) +
...
```
 ...
 OK, so this is a problem, I'd like to have NES values even if they are not statistically significant.
```{r}
