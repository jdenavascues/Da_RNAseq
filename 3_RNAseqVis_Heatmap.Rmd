...
## Using TPM counts with and without batch-correction

Either use Z-scored TPMs (range of values is 0.2 - 10,000) or use the log2(TPM+1) transform (ranges -2 to 16).
