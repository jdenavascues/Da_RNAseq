...
librarian::shelf(
  # data manip.
  dplyr, tidyr, stringr, org.Dm.eg.db, RcisTarget, purrr,
  # plotting
  pathview,  cetcolor, ggtheme, ggtext, ggrepel,
# convenience
  here)
```
...
Now I need to make heatmaps and GSEA plots from the results. I will use `genekitr` for this.
