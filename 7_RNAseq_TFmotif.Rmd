...
make the downloading from the RMD file:
https://stat.ethz.ch/R-manual/R-devel/library/utils/html/download.file.html

Merge the TF matches from v8 pure and hybrid
identify the TF family for each gene, make new column
...
start writing the bloody paper.
