...
# data
librarian::shelf(dplyr, stringr, DESeq2, edgeR, biomaRt, rtracklayer, GenomicFeatures, limma)
# graphics
librarian::shelf(ggplot2, pheatmap, scico, dendsort)  
# convenience
librarian::shelf(here, writexl, gzcon)
setwd(here())
```
