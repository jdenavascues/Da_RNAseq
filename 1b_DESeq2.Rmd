...
# Pipeline I: `DESeq2`-DGE analysis, visualisation with `limma`-based batch correction

## IA - `DESeq2`-DGE analysis
...
# 3 Pipeline II: `DESeq2`-DGE analysis, visualisation with `ComBat-seq`-based batch correction
# 4 Pipeline III: `ComBat-seq`-based batch correction as input for `edgeR`-DGE analysis & visualisation

Based on [this tutorial](https://rnabio.org/module-03-expression/0003/05/01/Batch-Correction/) from the [Griffith lab](https://griffithlab.org/).
